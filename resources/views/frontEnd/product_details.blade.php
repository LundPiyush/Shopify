@extends('frontEnd.layouts.master') @section('title','Detail Page') @section('slider') @endsection @section('content')
<div class="container">
    <div class="row">
        <div class="col-sm-3">
                ...
                <div class="col-sm-7">
                    <form action="{{route('addToCart')}}" method="post" role="form">
                        ...
                        <div class="product-information">
                            ...
                            <input type="text" name="quantity" value="{{$totalStock}}" id="inputStock" /> @if($totalStock>0)
                            <button type="submit" class="btn btn-fefault cart" id="buttonAddToCart">
                                <i class="fa fa-shopping-cart"></i> Add to cart
                            </button>
                            @endif
                            </span>
                            <p><b>Availability:</b> @if($totalStock>0)
                                <span id="availableStock">In Stock</span> @else
                                <span id="availableStock">Out of Stock</span> @endif
                            </p>
                ...
                <div class="tab-pane fade" id="reviews" >
                    <div class="col-sm-12">
                        <ul>
                            ...
                            <li><a href=""><i class="fa fa-clock-o"></i><?php echo date("h:i a");
                                ?></a></li>
...
<!------------------------caetgory section ends--------------------------------->


<!------------------------recommadations section start--------------------->
